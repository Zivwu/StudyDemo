...
import com.gossip.android.view.widget.heat.BezierEvaluator;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private Interpolator decdec = new DecelerateInterpolator();//先加速后减速
    private Interpolator fastLine = new FastOutLinearInInterpolator();//先加速后减速
    ...
    private void init() {
        ...
        Drawable green = getResources().getDrawable(R.drawable.pl_green);
        Drawable violet = getResources().getDrawable(R.drawable.pl_violet);
        ...
        interpolators[3] = decdec;
        interpolators[4] = fastLine;
    ...
    private Animator getAnimator(View target) {
        ...
        finalSet.setInterpolator(interpolators[random.nextInt(5)]);
